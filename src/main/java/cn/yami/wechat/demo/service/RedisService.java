...
import cn.yami.wechat.demo.utils.redis.KeyPrefix;
import cn.yami.wechat.demo.utils.redis.RedisConfig;
    ...
    public <T> boolean set(KeyPrefix prefix,String key,T value ){
        ...
        try{
            ...
            if (prefix.expireSeconds() <=0){
                ...
                //带过期时间的设置方式
                jedis.setex(prefix.getPrefix() + key,prefix.expireSeconds(),str);
            }
